...
namespace PrzychodniaLekarska
{
    public partial class Form1 : Form
    {
        ...
        public LinkedList<Lekarz> lekarze = new LinkedList<Lekarz>();
        ...
        private void generatorPacjentowLekarz(Lekarz _lekarz2)
        {
            ...
            while (true)
            {
                ...
                while (i < 4)
                {
                    ...
                    {
                        if (bO == 1) temp.lekarzeDoOdwiedzenia.AddLast(this.lekarz2);
                        if (bO == 2)
                        {
                            temp.lekarzeDoOdwiedzenia.AddLast(this.lekarz2);
                            temp.lekarzeDoOdwiedzenia.AddLast(this.lekarz3);
                        }
                        
                    }
                    else if(Thread.CurrentThread.Name.Equals("lekarz2"))
                    {
                        if (bO == 1) temp.lekarzeDoOdwiedzenia.AddLast(this.lekarz1);
                        if (bO == 2)
                        {
                            temp.lekarzeDoOdwiedzenia.AddLast(this.lekarz1);
                            temp.lekarzeDoOdwiedzenia.AddLast(this.lekarz3);
                        }
                    }
